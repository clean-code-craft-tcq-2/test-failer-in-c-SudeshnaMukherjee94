...
int main() {
    ...
    assert ((((ColorPairsTable)[3][0] == majorColor[0]) & (ColorPairsTable[3][1] == minorColor[3])) == 0) //Checking if the forth color pair in the table is White and Brown
    assert ((((ColorPairsTable)[4][0] == majorColor[0]) & (ColorPairsTable[4][1] == minorColor[4])) == 0) //Checking if the fifth color pair in the table is White and Slate
    assert ((((ColorPairsTable)[5][0] == majorColor[0]) & (ColorPairsTable[5][1] == minorColor[0])) == 0) //Checking if the sixth color pair in the table is Red and Blue
